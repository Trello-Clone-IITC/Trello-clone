...
import { useInboxCardCover, isHexColor } from "../hooks/useInboxCardCover";

interface InboxCoverPopoverProps {
...
export const InboxCoverPopover = ({
  children,
  onOpenChange,
  cardId,
  value,
}: InboxCoverPopoverProps) => {
  ...
  const {
    ...
    setImage,
    clear,
  } = useInboxCardCover(cardId, value);
        ...
        <div className="p-4">
          ...
          <ul className="grid grid-cols-3 gap-2 -mx-1 overflow-x-hidden p-1 list-none">
            {[
              ...
              "/images/background-2-hd.webp",
              "/images/background-3-hd.webp",
            ].map((image, index) => (
