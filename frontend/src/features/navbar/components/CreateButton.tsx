    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        {!showCreateBoard ? (
          ...
          <div className="w-72">
            <ul className="p-3">
              <li className="min-w-full -mx-5 rounded-none">
                <DropdownMenuItem
                  className={cn(
                    "flex flex-col w-full items-start py-[0.375rem] px-[0.75rem] rounded-none cursor-pointer",
                    isLight
              ...
              <li className="min-w-full -mx-5">
                <DropdownMenuItem
                  className={cn(
                    "flex flex-col items-start py-[0.375rem] px-[0.75rem] rounded-none cursor-pointer",
                    isLight
                      ? "hover:bg-[#f0f1f2] focus-visible:bg-[#f0f1f2]"
                      : "hover:bg-[#37383b] focus-visible:bg-[#37383b]"
                  )}
          ...
          // Create board form (replaces dropdown content)
          <div className="w-[304px] p-0 max-h-[675px] overflow-hidden">
            <CreateBoardForm
