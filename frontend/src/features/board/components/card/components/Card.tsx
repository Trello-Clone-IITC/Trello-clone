      ...
      >
        ...
        <div className="p-3">
          ...
          <div className="flex flex-wrap gap-1.5 mt-2">
            ...
            {/* Due date icon */}
            <span className="flex items-center text-gray-400 text-xs bg-red-500/20 px-1.5 py-0.5 rounded">
              <svg
                className="w-3.5 h-3.5 mr-1"
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          {/* Members section - bottom right */}
          <div className="flex justify-end mt-2">
            <div className="flex -space-x-1">
              <button
                className="relative inline-flex items-center justify-center w-6 h-6 rounded-full border-2 border-[#22272b] hover:z-10 transition-transform hover:scale-110"
                title="John Doe (johndoe)"
              >
                <div className="w-full h-full rounded-full bg-gray-500 flex items-center justify-center text-white text-xs font-medium">
                  JD
                </div>
              </button>
            </div>
