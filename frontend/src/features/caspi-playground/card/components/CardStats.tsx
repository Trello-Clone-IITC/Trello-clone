...
export const CardStats: React.FC<CardStatsProps> = ({ card }) => {
    ...
    <div className="mt-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap gap-1.5">
          {isWatched && (
            <span className="flex items-center text-gray-400 text-xs" title="Watching">
          ...
          {due && (
            <span
              className={`flex items-center text-xs px-1.5 py-0.5 rounded ${
                due.isPast ? "text-red-300 bg-red-500/20" : "text-gray-300 bg-white/10"
              }`}
              title="Due date"
            >
              <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          {showDescription && (
            <span className="flex items-center text-gray-400 text-xs" title="Description">
              <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
          ...
          {showComments && (
            <span className="flex items-center text-gray-400 text-xs" title="Comments">
              <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
          ...
          {showAttachments && (
            <span className="flex items-center text-gray-400 text-xs" title="Attachments">
              <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
          ...
          {showChecklist && (
            <span className="flex items-center text-gray-400 text-xs" title="Checklist">
              <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
