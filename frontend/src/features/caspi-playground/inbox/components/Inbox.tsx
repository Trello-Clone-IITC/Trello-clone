  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 relative">
        {cards.length === 0 ? (
          fullWidth ? (
            <div className="absolute inset-0 flex flex-col items-center justify-start pt-14">
              <div className="text-center">
                <h3 className="text-[16px] font-semibold text-[#dfe6ef]">
                  Consolidate your to-dos
                </h3>
                <p className="mt-2 text-[12px] text-[#9bb4d1]">
              ...
              >
                ...
                <div className="absolute left-1/2 -translate-x-1/2 -top-1">
                  <div className="w-14 h-14 rounded-full bg-[#1d2d49] border border-[#263956] flex items-center justify-center shadow-md">
                    <Mail className="w-5 h-5 text-[#9bb4d1]" />
                  </div>
                </div>
                {/* Left - Teams */}
                ...
                <div className="absolute left-1/2 -translate-x-1/2 -bottom-1">
                  <div className="w-14 h-14 rounded-full bg-[#1d2d49] border border-[#263956] flex items-center justify-center shadow-md">
                    <Smartphone className="w-5 h-5 text-[#9bb4d1]" />
                  </div>
                </div>
              </div>
              {/* Visibility note */}
              <div className="absolute bottom-10 text-[#9bb4d1] text-[12px] flex items-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="text-center py-8 text-[#9bb4d1] text-sm">
              No cards yet
            </div>
          )
        ) : (
      ...
      {/* Add Card */}
      <div className="p-3 border-t border-[#263956]">
        {isAddingCard ? (
          ...
          <Button
            ...
            variant="ghost"
            className="w-full justify-start text-[#9bb4d1] hover:text-white hover:bg-[#1b2c49]"
          >
      ...
      {/* Bottom dock (hidden when full width empty state) */}
