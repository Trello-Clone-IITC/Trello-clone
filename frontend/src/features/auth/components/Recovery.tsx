...
export default function Recovery() {
  ...
  return (
    <div className="bg-[#fafbfc] min-h-screen w-full flex justify-center items-center overflow-y-clip">
      ...
      />
      <Card
        className={`overflow-hidden px-4 md:px-8 shadow-lg py-10 rounded-none bg-[white] backdrop-blur-lg  flex justify-start items-center  w-[400px] ${
          isMobile ? "w-full min-h-screen" : "md:w-[400px] md:min-w-[400px]"
        }`}
      >
        <CardContent className="p-0 w-full">
          <div className="flex flex-col text-center items-center gap-[0.5px]">
            <div className="h-8">{trelloLogo}</div>
            <section className="flex flex-col  gap-2  w-full">
              <div className="text-left pt-6">
                <h2 className="text-[#172b4d] text-center text-[16px] font-bold w-full text-nowrap mb-2">
                  Can't log in?
                </h2>
              </div>
              <div className="flex flex-col gap-1 text-left">
                <p className="text-[#172b4d] text-xs font-bold">
                  We'll send a recovery link to
                </p>
                <Input
                  className="rounded border-1 border-[#8590a2] px-2 py-1.5 w-full"
        ...
        <CardFooter className="flex flex-col items-center justify-center pt-4 border-t-1 border-t-[#c1c7d0] ">
          <div className=" flex flex-col justify-center items-center gap-1 pt-2">
            ...
            <ul className="flex items-center gap-1 mt-[2px] text-xs">
              <a
                href="https://support.atlassian.com/atlassian-account/docs/troubleshoot-login-issues-with-your-atlassian-account/"
                target="_blank"
                rel="noreferrer noopener"
                className="text-[#2777e7] underline underline-offset-1 hover:no-underline"
                aria-label="Google Privacy Policy, (opens new window)"
