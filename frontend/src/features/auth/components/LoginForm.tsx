          ...
          <Form {...form}>
            <form className="" onSubmit={form.handleSubmit(handleContinue)}>
              <div className="flex flex-col gap-[10px]">
                          ...
                          <Popover>
                            <PopoverTrigger asChild>
                              <button
                                ...
                                aria-label="More info about Remember Me"
                              >
                                {infoIcon}
                              </button>
                            </PopoverTrigger>
                            ...
                            >
                              <p className="text-sm">
                                We remember your account information for the
                ...
                <div className="text-center text-sm flex justify-center items-center border-b-1 border-[#c1c7d0] pb-3">
                  <NavLink
                    to="/recovery"
                  ...
                  <span className="text-[#172b4d]  text-xl font-bold mx-2">
                    ∙
                  </span>
                  <NavLink
                    to="/sign-up"
