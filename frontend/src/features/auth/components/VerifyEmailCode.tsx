...
export function VerifyEmailCode() {
  ...
  return (
    <div className="bg-[#fafbfc] min-h-screen w-full flex justify-center items-center overflow-y-clip">
      ...
      />
      <Card
        className={`overflow-hidden px-4 md:px-8 shadow-lg py-10 rounded-none bg-[white] backdrop-blur-lg min-h-[512px] flex justify-start items-center h-[512px] w-[400px] ${
      ...
      >
        <CardContent>
          <div className="flex flex-col items-center text-center gap-[0.5px]">
            ...
            <section className="flex flex-col items-center justify-center gap-4 border-b-1 border-b-[#c1c7d0] pb-2">
              <div className="text-left pt-6">
                <h2 className="text-[#172b4d] text-2xl font-bold w-full text-nowrap">
              ...
              >
                <InputOTPGroup className="gap-2">
                  ...
                  <InputOTPSlot className={OTPstyle} index={4} />
                  <InputOTPSlot className={OTPstyle} index={5} />
                </InputOTPGroup>
              </InputOTP>
              <Button
                type="submit"
