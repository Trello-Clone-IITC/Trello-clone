...
import { CreateWorkspaceMemberInputSchema, UpdateWorkspaceMemberSchema, UserIdParamSchema, } from "@ronmordo/contracts";
const router = Router({ mergeParams: true });
router.get("/", workspaceController.getWorkspaceMembers);
router.post("/", validateRequest({ body: CreateWorkspaceMemberInputSchema }), workspaceController.addWorkspaceMember);
router.patch("/:userId", validateRequest({
