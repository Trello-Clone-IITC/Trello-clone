...
export class UserService {
    static async createUser(userData) {
        const { clerk_id, email, username, full_name, avatar_url, theme, email_notification, push_notification, bio, } = userData;
        const result = await query(`INSERT INTO users (clerk_id, email, username, full_name, avatar_url, theme, email_notification, push_notification, bio, created_at) 
    ...
    static async getUserByClerkId(clerk_id) {
    ...
    static async getUserWorkspaces(userId) {
        const result = await query(`SELECT wm.*, w.name as workspace_name, w.description as workspace_description
    ...
    static async getUserBoards(userId) {
        const result = await query(`SELECT bm.*, b.name as board_name, b.description as board_description, b.background
