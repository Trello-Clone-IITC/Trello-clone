...
const createAttachment = async (data, cardId, userId) => {
...
const getAttachmentById = async (attachmentId, userId) => {
...
const updateAttachment = async (attachmentId, updateData, userId) => {
