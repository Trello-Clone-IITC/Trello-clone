...
router.post("/", validateRequest({ body: UserIdParamSchema }), checklistItemAssigneeController.assignUserToItem);
router.delete("/:userId", validateRequest({ params: UserIdParamSchema }), checklistItemAssigneeController.removeUserFromItem);
